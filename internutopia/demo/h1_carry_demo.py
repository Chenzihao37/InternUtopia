...
from internutopia.bridge import create_h1_robot_cfg
...
def make_env():
    robot_cfg = create_h1_robot_cfg(position=(0.0, 0.0, 1.05), include_camera=False)
...
def main():
    ...
    robot = ArticulationView(prim_paths_expr="/World/env_0/robots/h1", name="h1_view")
    robot.initialize()
